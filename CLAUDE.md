...
- **Ollama local LLM** (`qwen3:8b` default, configurable) for Slice 3 explanations. Hosted Claude/Codex providers remain optional adapters for later quality/cost testing.
